...
!function (a, b) {
    ...
    n.extend({
        ...
        ajaxSettings: {
            ...
            processData: !0,
            async: !0,
            contentType: "operations/x-www-form-urlencoded; charset=UTF-8",
            accepts: {
                "*": ub,
                text: "text/plain",
                html: "text/html",
                xml: "operations/xml, text/xml",
                json: "operations/json, text/javascript"
            },
    ...
    l.cors = !!Ib && "withCredentials"in Ib, l.ajax = Ib = !!Ib, n.ajaxTransport(function (b) {
        ...
        accepts: {script: "text/javascript, operations/javascript, operations/ecmascript, operations/x-ecmascript"},
    ...
    n.ajaxSetup({
        ...
        var e, f, g, h = b.jsonp !== !1 && (Kb.test(b.url) ? "url" : "string" == typeof b.data && 0 === (b.contentType || "").indexOf("operations/x-www-form-urlencoded") && Kb.test(b.data) && "data");
